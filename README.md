...
Se crea o abre la base de datos SQLite.
Se verifica la existencia de la tabla usuarios.
Se cargan los registros existentes.
Se muestra el formulario de gestión.
El usuario puede crear, consultar, modificar o eliminar registros.
...
El sistema funciona como aplicación CRUD de escritorio y puede continuar ampliándose con nuevas funcionalidades, mejoras visuales, seguridad, reportes y administración avanzada de usuario
